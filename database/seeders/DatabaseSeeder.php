...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 3. Seed Customers
        $customerRamesh = Customer::updateOrCreate(
            ['email' => 'ramesh@example.com'],
            [
                'user_id' => $demoUser->id,
                'name' => 'Ramesh Kumar',
        ...
        $customerKumar = Customer::updateOrCreate(
        ...
        $customerABC = Customer::updateOrCreate(
        ...
        $customerPriya = Customer::updateOrCreate(
        ...
        // 4. Seed Services
        $serviceRes = Service::updateOrCreate(
        ...
        $serviceApt = Service::updateOrCreate(
        ...
        $serviceComm = Service::updateOrCreate(
        ...
        $serviceInd = Service::updateOrCreate(
        ...
        $serviceInt = Service::updateOrCreate(
        ...
        $serviceExt = Service::updateOrCreate(
        ...
        Enquiry::updateOrCreate(
            ['phone' => '9841098765', 'property_type' => 'Apartment'],
            [
        ...
        Enquiry::updateOrCreate(
            ['phone' => '9884011223', 'property_type' => 'Commercial'],
            [
        ...
        Enquiry::updateOrCreate(
            ['phone' => '9789054321', 'property_type' => 'House'],
            [
